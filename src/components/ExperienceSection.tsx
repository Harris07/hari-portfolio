    ...
    roles: [
      {
        ...
        bullets: [
          ...
          { Icon: Bot, heading: 'AI-Powered Design Tooling', body: 'Built a Figma plugin powered by Claude AI that converts iOS mocks to Android in seconds, automatically swapping platform-specific components. What used to take the team hours or even days of manual work now happens with a single click.' },
