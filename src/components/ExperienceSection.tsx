    ...
    roles: [
      {
        ...
        bullets: [
          ...
          { Icon: Bot, heading: 'AI-Powered Design Tooling', body: 'Built a Figma plugin powered by Claude AI that automatically converts iOS mocks to Android, swapping platform-specific components in seconds. Eliminated hours of manual recreating for the entire team and made cross-platform parity a one-click workflow.' },
